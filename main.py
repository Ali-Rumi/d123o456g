...
class TradingStrategy:
    ...
    def run_bnb_long(self):
        try:
            subprocess.Popen(["python", "doge_long.py"])
            print("Running doge_long.py")
        except Exception as e:
            print(f"Error running doge_long.py: {e}")

    def run_bnb_short(self):
        try:
            subprocess.Popen(["python", "doge_short.py"])
            print("Running doge_short.py")
        except Exception as e:
            print(f"Error running doge_short.py: {e}")
